...
test("safeDivide", () => {
  assert.equal(numbers.safeDivide(10, 2, 99), 5);
  assert.equal(numbers.safeDivide(7, 2, 99), 3.5);
  assert.equal(numbers.safeDivide(-10, 2, 99), -5);
  assert.equal(numbers.safeDivide(10, -2, 99), -5);
  assert.equal(numbers.safeDivide(-10, -2, 99), 5);
  assert.equal(numbers.safeDivide(0, 5, 99), 0);
  assert.equal(numbers.safeDivide(10, 0, 99), 99);
  assert.equal(numbers.safeDivide(10, -0, 99), 99);
  assert.equal(numbers.safeDivide("10", 2, 99), 99);
  assert.equal(numbers.safeDivide(10, "2", 99), 99);
  assert.equal(numbers.safeDivide(null, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, null, 99), 99);
  assert.equal(numbers.safeDivide(undefined, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, undefined, 99), 99);
  assert.equal(numbers.safeDivide(NaN, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, NaN, 99), 99);
  assert.equal(numbers.safeDivide(Infinity, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, Infinity, 99), 99);
  assert.equal(numbers.safeDivide(-Infinity, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, -Infinity, 99), 99);
  assert.equal(numbers.safeDivide(true, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, false, 99), 99);
  assert.equal(numbers.safeDivide(10n, 2, 99), 99);
  assert.equal(numbers.safeDivide(10, Symbol("2"), 99), 99);
  assert.equal(numbers.safeDivide(10, 0, "invalid"), "invalid");
  assert.equal(numbers.safeDivide(10, 0), undefined);
});

test("percentageChange", () => {
  assert.equal(numbers.percentageChange(100, 120), 20);
  assert.equal(numbers.percentageChange(100, 80), -20);
  assert.equal(numbers.percentageChange(50, 100), 100);
  assert.equal(numbers.percentageChange(100, 50), -50);
  assert.equal(numbers.percentageChange(100, 100), 0);
  assert.equal(numbers.percentageChange(100, 0), -100);
  assert.equal(numbers.percentageChange(12, 15), 25);
  assert.equal(numbers.percentageChange(64, 48), -25);
  assert.equal(numbers.percentageChange(12.5, 15), 20);
  assert.equal(numbers.percentageChange(7.5, 6), -20);
  assert.equal(numbers.percentageChange(-100, -80), 20);
  assert.equal(numbers.percentageChange(-100, -120), -20);
  assert.equal(numbers.percentageChange(-100, 100), 200);
  assert.equal(Number.isNaN(numbers.percentageChange(0, 100)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(-0, 100)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(0, 0)), true);
  assert.equal(Number.isNaN(numbers.percentageChange("100", 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, "120")), true);
  assert.equal(Number.isNaN(numbers.percentageChange(null, 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, null)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(undefined, 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, undefined)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(NaN, 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, NaN)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(Infinity, 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, Infinity)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(-Infinity, 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, -Infinity)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(true, 120)), true);
  assert.equal(Number.isNaN(numbers.percentageChange(100, false)), true);
